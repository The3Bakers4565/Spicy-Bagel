...
local queueont=(syn and syn.queue_on_teleport or queue_on_teleport)
game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(x)
    if x==Enum.TeleportState.Started then
        queueont("loadstring(game:HttpGet('https://raw.githubusercontent.com/The3Bakers4565/Spicy-Bagel/main/Other_Scripts/Phantom_Forces/Auto_Farm.lua'))()")
    end
end)
