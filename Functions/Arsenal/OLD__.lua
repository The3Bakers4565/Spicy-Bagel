...
local SpicyTable={
    ...
    ["Combat"]=
    {
        ...
        {
            ["Killall"]=false,
            ["KillallValue"]="Spoofed",
            ["GKillall"]=false,
            ["GGKillall"]=false,
            ["AutokillKiller"]=false,
            ["AutokillKillerValue"]="Spoofed",
            ["Assistedkills"]=false,
            ["Flameall"]=false,
...
coroutine.wrap(function()
    local oldtips=getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).TipMeOff
    getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).TipMeOff=function()end
    game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.Type.Text="Spicy Bagel Hub"
    game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.Descr.Text="Made By: The3Bakers#4565\ndiscord.gg/erdtnTSgng"
    game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.Frame.Text=""
    game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.Visible=true
    game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.ImageTransparency=0
    game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.Frame.Transparency=0
    game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.Descr.TextTransparency=0
    game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.Type.TextTransparency=0
    game:GetService("Players").LocalPlayer.PlayerGui.Tips.Enabled=true
    wait(5)
    local a=100
    for i=1,a do
        ...
        game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.Type.TextTransparency=0
        game:GetService("Players").LocalPlayer.PlayerGui.Tips.Enabled=true
        game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.ImageTransparency=(i/a)
        game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.Descr.TextTransparency=(i/a)
        game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.Type.TextTransparency=(i/a)
        game:GetService("Players").LocalPlayer.PlayerGui.Tips.TipFrame.Frame.Transparency=(i/a)
    end
    game:GetService("Players").LocalPlayer.PlayerGui.Tips.Enabled=false
    getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).TipMeOff=oldtips
    getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).TipMeOff()
end)()
...
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).firebullet,357,"NewFireRate")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).usethatgun,510,"NewEquipTime")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).updtprimary,6,"NewStoredAmmo")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).getammo,14,"NewStoredAmmo")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).countammo,62,"NewStoredAmmo")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).getprimaryammo,7,"NewStoredAmmo")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).reloadwep,91,"NewReloadTime")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).reloadwep,117,"NewAReload")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).reloadwep,85,"NewSReload")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).reloadwep,128,"NewEReload")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).reloadwep,122,"NewEReloadTime")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).givetools,34,"fakeadmin")
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).setcharacter,3,SpicyTable["CustomPrint"])
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).setcharacter,196,SpicyTable["CustomPrint"])
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).died200,5,SpicyTable["CustomPrint"])
debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).playannouncer,3,SpicyTable["CustomPrint"])
...
for _,v in pairs(game.ReplicatedStorage.Weapons:GetChildren())do
    ...
    a.Name="NewEquipTime"
    local a=Instance.new("NumberValue")
    a.Value=v.ReloadTime.Value
    a.Parent=v
    a.Name="NewReloadTime"
    local a=Instance.new("NumberValue")
    a.Value=v.StoredAmmo.Value
    a.Parent=v
    a.Name="NewStoredAmmo"
    if v:FindFirstChild("AReload")then
        local a=Instance.new("NumberValue")
        a.Value=v.AReload.Value
        a.Parent=v
        a.Name="NewAReload"
    end
    if v:FindFirstChild("SReload")then
        local a=Instance.new("NumberValue")
        a.Value=v.SReload.Value
        a.Parent=v
        a.Name="NewSReload"
    end
    if v:FindFirstChild("EReload")then
        local a=Instance.new("NumberValue")
        a.Value=v.EReload.Value
        a.Parent=v
        a.Name="NewEReload"
    end
    if v:FindFirstChild("EReloadTime")then
        local a=Instance.new("NumberValue")
        a.Value=v.EReloadTime.Value
        a.Parent=v
        a.Name="NewEReloadTime"
    end
...
PlayerCharacter:CreateToggle("No Third-Person Weapon",function(x)
    ...
    if not x then
        wait(.5)
        getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).usethatgun()
    end
end)
...
PlayerMovement:CreateToggle("Force Double Jump",function(x)
    ...
    if x then
        debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).jumpme,24,"FireRate")
    else
        debug.setconstant(getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).jumpme,24,"DoubleJump")
    end
end)
...
CombatCombat:CreateDropdown("Kill All Method",{"Spoofed","Max Crits","Demote","Max Damage"},1,function(x)
...
CombatCombat:CreateDropdown("Death Kill Method",{"Spoofed","Demote","Goldify","Goldify Demote"},1,function(x)
...
CombatCombat:CreateDropdown("Instant Kill Method",{"Damage Spoof","Demote","Goldify","Goldify Demote"},1,function(x)
...
CombatWeapons:CreateDropdown("Incendiary Rounds Method",{"Visual","Damage","Double Damage"},1,function(x)
                        ...
                        if game.Players.LocalPlayer.Character then
                            if game.Players.LocalPlayer.Character:FindFirstChild("Gun")then
                                if math.random(1,100)>=-SpicyTable["Silentaim"]["Silentaim"]["Hitchance"]+101 then
                                    if SpicyTable["VisiblePlayerHead"]then
                                        if SpicyTable["Silentaim"]["Silentaim"]["Hitpart"]=="Head"then
                                            game.ReplicatedStorage.Events.HitPart:FireServer(
                                                SpicyTable["VisiblePlayerHead"],
                                                SpicyTable["VisiblePlayerHead"].Position+Vector3.new(math.random(),math.random(),math.random()),
                                                getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun.Name,
                                                Crit and 2 or 1,
                                                (game.Players.LocalPlayer.Character.Head.Position-SpicyTable["VisiblePlayerHead"].Position).Magnitude,
                                                Backstab,
                                                Crit,
                                                false,
                                                1,
                                                false,
                                                getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun.FireRate.Value,
                                                getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun.ReloadTime.Value,
                                                getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun.Ammo.Value,
                                                getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun.StoredAmmo.Value,
                                                getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun.Bullets.Value,
                                                getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun.EquipTime.Value,
                                                getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun.RecoilControl.Value,
                                                getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun.Auto.Value,
                                                getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun["Speed%"].Value,
                                                game.ReplicatedStorage.wkspc.DistributedTime.Value
                                            )
                                        else
                                            game.ReplicatedStorage.Events.HitPart:FireServer(
                            ...
                            if SpicyTable["VisiblePlayerHead"]then
                                if SpicyTable["Silentaim"]["Silentaim"]["Hitpart"]=="Head"then
                                    ...
                                    game.ReplicatedStorage.Events.HitPart:FireServer(
                                        ...
                                        getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun.Auto.Value,
                                        getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).gun["Speed%"].Value,
                                        game.ReplicatedStorage.wkspc.DistributedTime.Value,true,true,true
                                    )
                                end
                            end
                        end
...
mt.__index=newcclosure(function(a,b)
    ...
    if SpicyTable["Combat"]["Weapon"]["Forcebackstab"]and SpicyTable["Combat"]["Weapon"]["ForcebackstabValue"]=="Spoofed"then
...
local OldFire=getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).firebullet
local OldRecoil=getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).ShakeCam
local OldGetAmmo=getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).getammo
...
getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).firebullet=function(...)
    SpicyTable["Flash"]=game.Workspace.CurrentCamera.CFrame
    if game.Workspace.CurrentCamera:FindFirstChild("Arms")then
        if game.Workspace.CurrentCamera.Arms:FindFirstChild("Flash")then
            SpicyTable["Flash"]=game.Workspace.CurrentCamera.Arms.Flash.CFrame
                        ...
                        if not getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).equipping then
                            if SpicyTable["Silentaim"]["Silentaim"]["Spreadwait"]and SpicyTable["Silentaim"]["Silentaim"]["Method"]then
                                pcall(function()
                                    if IsSpread()then
                                        pcall(function()
                                            getsenv(game.Players.LocalPlayer.PlayerGui.GUI.Client).firebullet()
                                        end)
                                    end
                                end)
                            else
...
coroutine.wrap(function()
    while game.RunService.RenderStepped:Wait()do
        if SpicyTable["Combat"]["Weapon"]["Fastspool"]and SpicyTable["Mouse1Toggle"]then
