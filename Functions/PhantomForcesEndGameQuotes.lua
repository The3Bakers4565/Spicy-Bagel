-- Script GUID: {E3B96338-12AD-492A-86CB-967A88603FEE}
...
return {
    ...
    "Life is like a mountain. You can say you reached the top, but only after climbing back down.",
    "There are no heroes, There's only heroic decisions.",
    "It's not your gun if you're dead.",
    "The war ends when everyone stops playing the game.",
    "Phantom... Ghost... Does it matter?",
